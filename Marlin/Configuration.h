...
#define CUSTOM_MACHINE_NAME "Ender-3 + Pro S 4.2.7 "

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "b84ea7b0-7e6f-11ed-a1eb-0242ac120002"
 ...
 */
Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, 0, -2 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 50, 30, 30, 30 } // (mm) Left, Front, Right, Back insets
